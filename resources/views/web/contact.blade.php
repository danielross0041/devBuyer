                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  placeholder="Enter your number" required="" name="phone">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <textarea class="form-control" placeholder="Write Your Message" rows="2" name="msg"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
