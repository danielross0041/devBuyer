                    ...
                    <div class="footer-main">
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                ...
                                <ul class="paymant">
                                    <li>
                                        <a href="javascript:void(0)"><img src="{{asset('web/assets/images/layout-1/pay/1.png')}}" class="img-fluid" alt="pay"></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><img src="{{asset('web/assets/images/layout-1/pay/2.png')}}" class="img-fluid" alt="pay"></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><img src="{{asset('web/assets/images/layout-1/pay/3.png')}}" class="img-fluid" alt="pay"></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><img src="{{asset('web/assets/images/layout-1/pay/4.png')}}" class="img-fluid" alt="pay"></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><img src="{{asset('web/assets/images/layout-1/pay/5.png')}}" class="img-fluid" alt="pay"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    <li><i class="fa fa-map-marker"></i>99 Wall Street #157 New York<br><span>10005</span></li>
                                    <li><i class="fa fa-phone"></i>call us: <span>+(929) 443-5686</span></li>
                                    <li><i class="fa fa-envelope-o"></i>email us: info@devbuyer.com</li>
                                    <li><i class="fa fa-share"></i>fax <span>123456</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="footer-box">
        ...
        <div class="modal-content ">
            <div class="modal-body">
                ...
                <div class="offer-content ">
                    <img src="{{asset('web/assets/images/theme-modal/black-friday.jpg')}}" class="img-fluid bg-img" alt="">
                    <div>
                        <div>
                            ...
                            <h3>black friday</h3>
                            <div class="timer">
                                <p id="demo4"><span>126<span class="timer-cal">Days</span></span><span>6<span class="timer-cal">Hrs</span></span><span>22<span class="timer-cal">Min</span></span><span>53<span class="timer-cal">Sec</span></span>
                                </p>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img">
                            <img src="{{asset('web/assets/images/mega-store/product/8.jpg')}}" alt="" class="img-fluid bg-img">
                        </div>
                    </div>
        ...
        <div class="modal-content ">
            <div class="modal-body">
                    ...
                    <div class="product-img">
                        <div class="media">
                            <div class="img-wraper">
                                <a href="void:;">
                                    <img src="{{asset('web/assets/images/mega-store/product/9.jpg')}}" alt="" class="img-fluid">
                                </a>
                            </div>
                ...
                <div class="pro-group mb-0">
                    <div class="modal-btn">
                        <a href="void:;" class="btn btn-solid btn-sm">
                            add to cart
                        </a>
                        <a href="void:;" class="btn btn-solid btn-sm">
                            more detail
    ...
    <div class="cart-inner">
        ...
        <div class="cart_media">
            <ul class="cart_product">
                ...
                $total = 0;
                ?>
                @foreach($cart as $key => $cart_array)
                <?php
                $product = App\Models\product::where('id',$cart_array['product_id'])->first();
                $total += $product->price*$cart_array['quantity'];
                ?>
                <li>
                    <div class="media">
                        <a>
                        ...
                        <div class="media-body">
                            ...
                            <h6>
                                ${{$product->price}} <!-- <span>$120.00</span> -->
                            </h6>
                            <div class="addit-box">
                                <div class="qty-box">
                                    <div class="input-group">
                                        <button class="qty-minus"></button>
                                        <input class="qty-adj form-control qty" type="number" min="1" max="9" value="{{$cart_array['quantity']}}" />
                                        <button class="qty-plus"></button>
                                    </div>
                                </div>
                                <div class="pro-add">
                                    <!-- <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#edit-product"> -->
                                    <a href="javascript:void(0)" class="update-cart" data-cart_id="{{$key}}">
                                        <i data-feather="edit"></i>
                                    </a>
                                    <a href="javascript:void(0)" class="delete-cart" data-cart_id="{{$key}}">
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="void:;">
                            <img alt="megastore1" class="me-3" src="{{asset('web/assets/images/mega-store/product/1.jpg')}}">
                        </a>
                        <div class="media-body">
                            <a href="void:;">
                ...
                <li>
                    <div class="media">
                        <a href="void:;">
                            <img alt="megastore1" class="me-3" src="{{asset('web/assets/images/mega-store/product/2.jpg')}}">
                        </a>
                        <div class="media-body">
                            <a href="void:;">
                ...
                <li>
                    <div class="media">
                        <a href="void:;">
                            <img alt="megastore1" class="me-3" src="{{asset('web/assets/images/mega-store/product/3.jpg')}}">
                        </a>
                        <div class="media-body">
                            <a href="void:;">
            ...
            <ul class="cart_total">
                ...
                <li>
                    <div class="buttons">
                        <a href="void:;" class="btn btn-solid btn-block btn-md">view wislist</a>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="cart-inner">
        ...
        <form class="theme-form" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="email" placeholder="Email" required="" name="name">
            </div>
            <div class="form-group">
...
<div class="product-notification" id="dismiss">
    ...
    <div class="media">
        <img class="me-2" src="{{asset('web/assets/images/mega-store/hot-deal/3.jpg')}}" alt="Generic placeholder image">
        <div class="media-body">
