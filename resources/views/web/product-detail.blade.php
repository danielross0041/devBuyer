                                ...
                                <!-- <div class="row">
                                    <div class="col-12 p-0">
                                        <div class="slider-nav">
                                            <div><img src="{{asset('web/assets/images/product-sidebar/001.jpg')}}" alt="" class="img-fluid"></div>
                                            <div><img src="{{asset('web/assets/images/product-sidebar/002.jpg')}}" alt="" class="img-fluid"></div>
                                            <div><img src="{{asset('web/assets/images/product-sidebar/003.jpg')}}" alt="" class="img-fluid"></div>
                                            <div><img src="{{asset('web/assets/images/product-sidebar/004.jpg')}}" alt="" class="img-fluid"></div>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
                                ...
                                <div class="product-right ">
                                    <div class="pro-group">
                                        ...
                                        <div class="revieu-box">
                                            ...
                                            <a href="void:;"><span>(6 reviews)</span></a>
                                        </div>
                                        ...
                                        <div class="modal fade" id="sizemodal">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body"><img src="{{asset('web/assets/images/size-chart.jpg')}}" alt="" class="img-fluid "></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex quan_min">
                                        <input type="number" name="qty" id="qty" min="1" max="9" value="1">
                                        <a class="btn btn-rounded btn-md" id="add_to_cart" data-id="{{$product->id}}">Add to Cart</a>
                                    </div>
                                    <!-- <div class="pro-group">
                            ...
                            <div class="col-sm-12 col-lg-12">
                                ...
                                <div class="tab-content nav-material" id="top-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="top-profile" role="tabpanel" aria-labelledby="profile-top-tab">
                                        <p class="pl-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled
                                        ...
                                        <form class="theme-form" method="POST">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter your Review Subjects" required name="review">
                                                </div>
                                                <div class="col-md-12">
                                                    <label>Review Title</label>
                            ...
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/1.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-back">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/a1.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                    ...
                    <div>
                        <div class="product-box">
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/3.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-back">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/a3.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-icon icon-inline">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart">
                    ...
                    <div>
                        <div class="product-box">
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/4.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-back">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/a4.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-icon icon-inline">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart">
                    ...
                    <div>
                        <div class="product-box">
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/5.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-back">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/a5.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-icon icon-inline">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart">
                    ...
                    <div>
                        <div class="product-box">
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/6.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-back">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/a6.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-icon icon-inline">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart">
                    ...
                    <div>
                        <div class="product-box">
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/7.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-back">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/a7.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-icon icon-inline">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart">
                    ...
                    <div>
                        <div class="product-box">
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/8.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-back">
                                    <a href="{{route('sample_list')}}">
                                        <img src="{{asset('web/assets/images/layout-2/product/a8.jpg')}}" class="img-fluid  " alt="product">
                                    </a>
                                </div>
                                <div class="product-icon icon-inline">
                                    <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart">
