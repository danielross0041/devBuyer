...
Route::get('/sample-list', [IndexController::class, 'sample_list'])->name('sample_list');
Route::get('/product-list/{id}', [IndexController::class, 'product_list'])->name('product_list');
Route::get('/product/{url}', [IndexController::class, 'product_detail'])->name('product_detail');
...
Route::get('forget_cart', [CartController::class , 'forget_cart'])->name('forget_cart');    
Route::get('delete_cart', [CartController::class , 'delete_cart'])->name('delete_cart');   

// Stripe
 
Route::get('stripe', [MerchantController::class, 'stripe']);
Route::post('stripe', [MerchantController::class, 'stripePost'])->name('stripe.post');
